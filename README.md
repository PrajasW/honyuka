...
Honyuka (ほにゅか, mispronunciation of Honyakuya  = translator) is a standalone Android app that translates downloaded manga chapters and makes the translated output readable in Mihon (and its fork TachiyomiAT).
